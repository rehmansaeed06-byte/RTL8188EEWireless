...
/* be16_to_cpup: pointer-dereferencing variant, real rtlwifi usage
 * (base.c:1506,1603 -- be16_to_cpup((__be16 *)ether_type_ptr)).
 * Dereferences a big-endian u16 pointer and byteswaps to host order,
 * matching upstream linux/byteorder/generic.h semantics. */
